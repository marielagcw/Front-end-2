...
// Corre codigo
let templateHTML = "";
let texto = noticias.forEach((noticia) => {
  ...
  let template = `<div class="carousel--item">
          ...
          <div class="carousel--item__details">
              ...
              <p class="carousel--item__details--title">${noticia.titulo}</p>
              <p class="carousel--item__details--subtitle">${noticia.descripcion}</p>
          </div>
      </div>`;
...
document.querySelector(".carousel__containerNacional").innerHTML = templateHTML;

// Corre codigo
let templateHTMLinternacional = "";
let textoInternacional = noticias.forEach((noticia) => {
  if(noticia.tipoNacional == false){
  let templateInternacional = `<div class="carousel--item">
          <img class="carousel--item__img"
              src="${noticia.imgUrl}"
              alt="cabina">
          <div class="carousel--item__details">
  ...
  templateHTMLinternacional += templateInternacional;
}});

document.querySelector(".carousel__containerInternacional").innerHTML = templateHTMLinternacional;
